...
Use a case opener tool or scissors to remove the back of the watch. You can also use a piece of blue tack as an alternative method for removing the back of the watch if you do not have a case opener tool. Apply downward pressure and twist back to open the case.

See this video if you would like to use scissors:
[youtube:BpGG7td_NaM]

See this video if you have a watch case wrench:
[youtube:ECMdv_QaXCA]