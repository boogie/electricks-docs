...
- **Button 1:** [ Atom Time ](https://electricks.info/docs/atom-remote/atom-time/) – set the time on an SB Watch
- **Button 2:** [ Atom Stack ](https://electricks.info/docs/atom-remote/atom-stack/) – learn and peek at card stacks
- **Button 3:** [ Atom Pi ](https://electricks.info/docs/atom-remote/atom-pi/)– offline Pi Revelations app
- **Button 4:** [ Atom Square ](https://electricks.info/docs/atom-remote/atom-square/)– magic square generator
- **Button 5:** [ Atom Practice ](https://electricks.info/docs/atom-remote/atom-practice/)– practice entering time
- **Button 6:** Atom Alias – to change the Bluetooth name and launch an other app
- **Button 7:** [ Numeric keyboard ](https://electricks.info/docs/atom-remote/numeric-keyboard/) – enter numbers
- **Button 8:** [ NOKIA alphanumeric keyboard ](https://electricks.info/docs/atom-remote/nokia-alphanumeric-keyboard/) – enter any word
- **Button 9:** [ Cursor keyboard ](https://electricks.info/docs/atom-remote/cursor-keyboard/) – for Inject 2 swipes (for example)
- **Button 10:** [ Media controls ](https://electricks.info/docs/atom-remote/media-controls/) – control music
- **Button 11:** [ Custom keyboard ](https://electricks.info/docs/atom-remote/custom-keyboard/) – type WikiTest keywords, setup your own keyboard
